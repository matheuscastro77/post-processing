...
unrealBloomPassFolder.add(unrealBloomPass, 'strength').min(0).max(2).step(0.001)
unrealBloomPassFolder.add(unrealBloomPass, 'radius').min(0).max(2).step(0.001)
unrealBloomPassFolder.add(unrealBloomPass, 'threshold').min(0).max(1).step(0.001)
...
const rgbShiftShaderFolder = gui.addFolder('rgbShiftShader')
rgbShiftShaderFolder.add(rgbShiftShader, 'enabled')
